    ...
    <div class="custom-menu">
        <div id="shopping-cart">
                ...
                <c:forEach var="map" items="${sessionScope.myCartItems}">
                    <div class="product product-widget">
                        ...
                        <div class="product-body">
                            <h3 class="product-price"><fmt:formatNumber value="${map.value.sanPham.gia}"/> VNĐ</h3>
            ...
            <div class="shopping-cart-btns">
                <a onclick="location.href='checkout.htm'" class="primary-btn" style="cursor: pointer;">Chi tiết <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
</li>