                        ...
                        <tbody>
                            <c:forEach var="map" items="${myCartItems}">
                                <tr>
                                    ...
                                    <td class="details">
                                       <h4>${map.value.sanPham.tenSp}</h4>
                                    </td>
                                    <td class="price text-center"><strong><fmt:formatNumber value="${map.value.sanPham.gia}"/> VNĐ</strong><br><del class="font-weak"></del></td>
                                    
                                    <td><a class="fa fa-arrow-left" href = "giam.htm?maSp=${map.value.sanPham.maSp}"/></td>
                                    <td class="qty text-center">
                                        
                                        <input class="input" aria-label="quantity"  type="number" value="${map.value.soLuong}"/>
                                    </td>
                                    <td><a class="fa fa-arrow-right" href = "tang.htm?maSp=${map.value.sanPham.maSp}"/></td>
                                    <td class="total text-center"><strong class="primary-color"><fmt:formatNumber value="${map.value.soLuong * map.value.sanPham.gia}"/>VNĐ</strong></td>
                ...
                <div class="shiping-methods">
                    ...
                    <c:forEach var="vc" items="${vanchuyen}">
                        <div class="input-checkbox">
                            <a class="test" onclick="location.href = 'checkedvanchuyen.htm?maVc=${vc.maVc}'" id="shipping-1">
                                <label style="cursor: pointer;" for="shipping-1">${vc.tenVc} -  <fmt:formatNumber value="${vc.gia}"/> VNĐ</label>
                                <div class="caption">
                                    <p>${vc.mota}
                                    <p>
                                </div>                                
