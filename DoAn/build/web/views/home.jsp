            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="getLaptop.htm">
                            <img src="https://image.freepik.com/free-vector/online-shopping-isometric-icon-internet-purchase-laptop-with-shop-basket-screen-online-payment_39422-973.jpg" height="275px" alt="">
                            <div class="banner-caption text-center">
                    ...
                    <!-- banner -->
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="getLinhkien.htm">
                            <img src="http://capcuulaptop.com/wp-content/uploads/2017/06/linh-kien-laptop-chinh-hang-gia-tot-600x300.jpg" height="275px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="white-color">Phụ kiện</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
                    ...
                    <div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3">
                        <a class="banner banner-1" href="getLaptopdoitra.htm">
                            <img src="https://cdn.tgdd.vn/Files/2020/12/04/1311312/t_800x450.jpg" height="275px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="white-color">Laptop cũ đổi trả</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
        ...
        <div class="section">
            ...
            <div class="container">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="product product-single">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-price"> <label class="product-old-price">VNĐ</label></h3>
                ...
                <div style=" text-align: center ;padding-right: 20px">
                    <mytag:my_tag steps="8" offset="${offset}" count="${numberProductDetail}"   uri="showsanpham.htm" next="&raquo;"   previous="&laquo;"/>
                </div>
                <!-- /Product Single -->
            </div>
        </div>
    ...
    <div class="section section-grey">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="banner banner-1">
                        <img src="/DoAn/views/img/banner13.jpg" alt="" style="height: 570px">
                        <div class="banner-caption text-center" style="margin-top: 84px">
                            <h1 class="primary-color"><br><span class="white-color font-weak"></span></h1>
                            <button class="primary-btn">Săn ngay</button>
                        </div>
                    </div>
                </div>
                <!-- /banner -->
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="/DoAn/views/img/bn1.png" alt="">
                        <div class="banner-caption text-center" style="margin-top: 95px">
                            <h2 class="white-color">Mới ra mắt</h2>
                        </div>
                    </a>
                </div>
                <!-- /banner -->
                ...
                <!-- banner -->
                <div class="col-md-4 col-sm-6" style="margin-top: 115px">
                    <a class="banner banner-1" href="#">
                        <img src="/DoAn/views/img/bn2.jpg" alt="">
                        <div class="banner-caption text-center" style="margin-top: 92px">
                            <h2 class="white-color">Mới ra mắt</h2>
                        </div>
                    </a>
                </div>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="title">Giá tốt hôm nay</h2>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="/DoAn/views/img/bn3.png" alt="">
                        <div class="banner-caption">
                            <h2 class="white-color">Ưu đãi</h2>
