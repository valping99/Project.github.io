                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <f:form onsubmit="return validateForm()" id="register-form" type="reset" commandName="khachHang" action="dangKyKhachHang.htm" method="post" role="form" style="display: none;">
                            ...
                            <div class="form-group">
                                <input type="password" path="matKhau" id="ConfirmPassword" class="form-control" placeholder="Xác nhận mật khẩu" required="required"/>
                            </div> 
                            <div class="form-group">
                                <f:input type="text" path="diaChi" id="username" tabindex="1" class="form-control" placeholder="Địa chỉ" value="" required="required"/>
                            </div>
                            <div class="form-group">
                                <f:input type="text" path="soDienThoai" id="phone" tabindex="1" class="form-control" placeholder="Số điện thoại" value="" required="required"/>
                            </div>
                            <div class="form-group">
